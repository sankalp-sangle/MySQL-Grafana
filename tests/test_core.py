...
TEST_QUERY1 = r'SELECT time_in as \"time\", concat(\"Switch \",switch) AS metric, queue_depth FROM packetrecords where time_in != 0 ORDER BY time_in'
TEST_QUERY2 = r'SELECT from_unixtime(time_in) as \"time\", concat(\"Switch \",switch) AS metric, queue_depth FROM packetrecords where time_in != 0 ORDER BY time_in'
TEST_QUERY3 = r'SELECT time_in as \"time\", concat(\"Switch \",switch) AS metric, link_utilization FROM packetrecords where time_in != 0 ORDER BY time_in'
TEST_QUERY4 = r'SELECT from_unixtime(time_in) as \"time\", concat(\"Switch \",switch) AS metric, link_utilization FROM packetrecords where time_in != 0 ORDER BY time_in'
